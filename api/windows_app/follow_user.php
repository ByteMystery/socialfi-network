...
if ($type == 'follow_user') {
    ...
    if (empty($json_error_data)) {
        ...
        if (empty($user_login_data)) {
            ...
            if (Wo_IsFollowing($_POST['recipient_id'], $user_id) === true || Wo_IsFollowRequested($_POST['recipient_id'], $user_id) === true) {
                if (Wo_DeleteFollow($_POST['recipient_id'], $user_id)) {
                    $follow_data = array('follow' => 'unfollowed');
                }
            } else {
                if (Wo_RegisterFollow($_POST['recipient_id'], $user_id)) {
                    $follow_data = array('follow' => 'followed');
                }
            }
        }
    } else {
