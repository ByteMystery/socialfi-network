...
if (!empty($user_data['gender']) && $user_data['gender'] == 'female' && $wo['user']['avatar_org'] == 'upload/photos/d-avatar.jpg' && empty($_FILES["avatar"])) {
    $user_data['avatar'] = 'upload/photos/f-avatar.jpg';
}
if (!empty($user_data['gender']) && $user_data['gender'] == 'male' && $wo['user']['avatar_org'] == 'upload/photos/f-avatar.jpg' && empty($_FILES["avatar"])) {
